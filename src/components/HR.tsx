...
import { Users, UserPlus, Search, FileText, Calendar as CalendarIcon, Award } from 'lucide-react';
import { toast } from 'sonner@2.0.3';

const employees = [
  { id: 1, name: 'John Silva', department: 'Sales', position: 'Sales Manager', email: 'john@santrading.com', phone: '+94 77 123 4567', status: 'Active' },
  { id: 2, name: 'Sarah Fernando', department: 'Operations', position: 'Warehouse Supervisor', email: 'sarah@santrading.com', phone: '+94 77 234 5678', status: 'Active' },
  { id: 3, name: 'Michael Perera', department: 'Finance', position: 'Accountant', email: 'michael@santrading.com', phone: '+94 77 345 6789', status: 'Active' },
  { id: 4, name: 'Emma Jayawardena', department: 'HR', position: 'HR Officer', email: 'emma@santrading.com', phone: '+94 77 456 7890', status: 'On Leave' },
  { id: 5, name: 'David Wickramasinghe', department: 'Sales', position: 'Sales Executive', email: 'david@santrading.com', phone: '+94 77 567 8901', status: 'Active' },
];
...
const attendanceData = [
  ...
  { employee: 'David Wickramasinghe', present: 23, absent: 1, late: 1, leaves: 1 },
];

const leaveRequests = [
  { id: 1, employee: 'John Silva', type: 'Annual Leave', from: '2025-11-01', to: '2025-11-03', days: 3, status: 'Pending' },
  { id: 2, employee: 'Sarah Fernando', type: 'Sick Leave', from: '2025-10-28', to: '2025-10-28', days: 1, status: 'Approved' },
  { id: 3, employee: 'David Wickramasinghe', type: 'Annual Leave', from: '2025-11-15', to: '2025-11-20', days: 6, status: 'Pending' },
];

const performanceData = [
  { employee: 'John Silva', rating: 4.5, goals: '8/10', training: '3/5', lastReview: '2025-09-15' },
  { employee: 'Sarah Fernando', rating: 4.8, goals: '9/10', training: '4/5', lastReview: '2025-09-20' },
  { employee: 'Michael Perera', rating: 4.2, goals: '7/10', training: '2/5', lastReview: '2025-09-10' },
  { employee: 'Emma Jayawardena', rating: 4.6, goals: '8/10', training: '5/5', lastReview: '2025-09-18' },
  { employee: 'David Wickramasinghe', rating: 4.0, goals: '6/10', training: '3/5', lastReview: '2025-09-12' },
];
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {attendanceData.map((att, idx) => {
                        ...
                        const percentage = ((att.present / total) * 100).toFixed(1);
                        return (
                          <tr key={idx} className="border-b hover:bg-gray-50">
                            <td className="py-3 px-4">{att.employee}</td>
                            <td className="py-3 px-4 text-green-600">{att.present}</td>
                            <td className="py-3 px-4 text-red-600">{att.absent}</td>
                            <td className="py-3 px-4 text-orange-600">{att.late}</td>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-left py-3 px-4">Training Progress</th>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={dept.name} className="border rounded-lg p-4 text-center">
                <div className={`w-12 h-12 ${dept.color} rounded-full mx-auto mb-2 flex items-center justify-center text-white`}>
                  {dept.count}
                </div>
